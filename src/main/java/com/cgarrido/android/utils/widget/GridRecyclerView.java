...
public class GridRecyclerView extends RecyclerView {
    ...
    public void setLayoutManager(LayoutManager layout) {
        if (layout instanceof GridLayoutManager || isInEditMode()) {
            super.setLayoutManager(layout);
        } else {
            throw new ClassCastException("You might use a GridLayoutManager with GridRecyclerView.");
        }
    }
    ...
    protected void attachLayoutAnimationParameters(View child, ViewGroup.LayoutParams params, int index, int count) {
        ...
        if (!isInEditMode() && getAdapter() != null && getLayoutManager() instanceof GridLayoutManager) {
